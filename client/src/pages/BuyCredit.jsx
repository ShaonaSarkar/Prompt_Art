    ...
    className='min-h-[80vh] text-center pt-14 mb-10'>
      ...
      <div className='flex flex-wrap justify-center gap-6 text-left'>
        {plans.map((item,index)=>(
          <div key={index} className='bg-white drop-shadow-sm border border-gray-300 rounded-lg py-12 px-12 text-gray-600 hover:scale-105 transition-all duration-500'>
